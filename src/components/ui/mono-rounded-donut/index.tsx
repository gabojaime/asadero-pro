...
export function MonoRoundedDonutChart({
  ...
  return (
    <div
      className="relative min-h-[290px] min-w-0 max-w-full w-full rounded-xl border border-border p-4"
    ...
    >
      ...
      <p className="text-center text-[11px] text-muted-foreground break-words">
